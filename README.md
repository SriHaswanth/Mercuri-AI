[Readme.txt](https://github.com/user-attachments/files/31499877/Readme.txt)
...
|-- backend/
|   |-- models/
|   |   `-- Slot.js |   |-- routes/ |   |   |-- agent.js |   |   |-- bookings.js |   |   `-- slots.js
|   |-- services/
|   |   `-- aiService.js |   |-- tests/ |   |   `-- booking.test.js
|   |-- package.json
|   |-- seed.js
|   `-- server.js |-- frontend/ |   |-- public/ |   |   `-- index.html
|   |-- src/
|   |   |-- App.css
|   |   |-- App.js
